  ...
  return (
    <HomeContainer>
        ...
        <div className="inner">
          <p>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=web-analyzer&utm_source=wcgh"
            >
              Terminal Trove
            ...
            <span className="cta">
              ...
              the <a
                ...
                rel="noreferrer"
                className="cta"
                href="https://terminaltrove.com/newsletter?utm_campaign=github&utm_medium=referral&utm_content=web-analyzer&utm_source=wcgh"
                >
          ...
          <a
            ...
            rel="noreferrer"
            href="https://terminaltrove.com/?utm_campaign=github&utm_medium=referral&utm_content=web-analyzer&utm_source=wcgh">
            <img width="120" alt="Terminal Trove" src="https://i.ibb.co/NKtYjJ1/terminal-trove-web-analyzer.png" />
          </a>
        </div>
      ...
      <SiteFeaturesWrapper>
        ...
        <div className="links">
          <a target="_blank" rel="noreferrer" href="https://github.com/mvptayco/webAnalyzer" title="Check out the source code and documentation on GitHub, and get support or contribute">
